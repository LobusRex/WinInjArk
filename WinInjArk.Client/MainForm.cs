...
internal partial class MainForm : Form
{
    ...
    private readonly OnlyOne_FormOpener<DesktopForm> _desktopFormOpener;

    public MainForm(
        IFormLogSink logProvider,
        ILogger<MainForm> logger,
        ListFormOpener listFormOpener,
        OnlyOne_FormOpener<DesktopForm> desktopFormOpener)
    {
        InitializeComponent();
        ...
        _desktopFormOpener = desktopFormOpener;
    ...
    {
        _logger.LogInformation("Clicked desktop form button.");

        _desktopFormOpener.Open();
    }
